...
<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Sagar Tech</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="conversions">
                ...
                <div class="menu-title">Conversions</div>
            </a>
        </li>
        <!-- <li>
            <a href="overallreport">
                <div class="parent-icon"><i class="fa fa-bar-chart"></i>
                </div>
                <div class="menu-title">Overall Report</div>
            </a>
        </li>
        <li>
            <a href="detailedreport">
                <div class="parent-icon"><i class="fa fa-list"></i>
                </div>
                <div class="menu-title">Detailed Report</div>
            </a>
        </li>
        <li>
            <a href="testreport">
                ...
                <div class="menu-title">Test Report</div>
            </a>
        </li> -->
        <!-- <li>
            <a href="eventreport">
                <div class="parent-icon"><i class="fa fa-area-chart"></i>
                </div>
                <div class="menu-title">Event Report</div>
            </a>
        </li>
        <li>
            <a href="events">
                <div class="parent-icon"><i class="fa fa-bullseye"></i>
                </div>
        ...
        <li>
            <a href="offers">
                <div class="parent-icon"><i class="fa fa-gift"></i>
                </div>
